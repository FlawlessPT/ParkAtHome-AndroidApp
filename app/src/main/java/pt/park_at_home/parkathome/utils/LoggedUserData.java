...
public class LoggedUserData
{
    ...
    public LoggedUserData(Context context)
    {
    ...
    public void create()
    {
        try
        {
            try
            {
                this.file = new File(context.getFilesDir(), Variables.FILE_NAME_ALL_DATA);
                //System.out.println("[LoggedUserData] Ficheiro criado com sucesso!");
            } catch (Exception e)
            {
                e.printStackTrace();
            }
